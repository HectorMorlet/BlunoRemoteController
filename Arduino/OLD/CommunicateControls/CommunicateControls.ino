...
void receivedCommand(String command) {
  if (command == MOTOR_ONE_SET_HIGH) {
    // Second motor on
    Serial.println("MOTOR ONE HIGH");//digitalWrite(MOTOR_ONE_PIN, HIGH);
  } else if (command == MOTOR_ONE_SET_LOW) {
    // Second motor off
    Serial.println("MOTOR ONE LOW");//digitalWrite(MOTOR_ONE_PIN, LOW);
  } else if (command == MOTOR_TWO_SET_HIGH) {
    // Second motor on
    Serial.println("MOTOR TWO HIGH");//digitalWrite(MOTOR_TWO_PIN, HIGH);
  } else if (command == MOTOR_TWO_SET_LOW) {
    // Second motor off
    Serial.println("MOTOR TWO LOW");//digitalWrite(MOTOR_TWO_PIN, LOW);
  } else {
